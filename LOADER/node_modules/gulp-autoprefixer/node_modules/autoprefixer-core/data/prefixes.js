(function() {
  ...
  feature = function(data, opts, callback) {
    var browser, match, need, support, version, versions, _ref, _ref1;
    if (!callback) {
  ...
  prefix = function() {
    var data, i, name, names, _i, _j, _len, _results;
    ...
    for (_j = 0, _len = names.length; _j < _len; _j++) {
      ...
      _results.push((function() {
        ...
        _results1 = [];
        for (i in data) {
          _results1.push(result[name][i] = data[i]);
        }
        return _results1;
      })());
    }
  ...
  add = function() {
    ...
    for (_j = 0, _len = names.length; _j < _len; _j++) {
      name = names[_j];
      _results.push(result[name].browsers = sort(result[name].browsers.concat(data.browsers)));
    }
    return _results;
  };
  ...
  feature(require('caniuse-db/features-json/css-placeholder'), function(browsers) {
    browsers = browsers.map(function(i) {
      ...
      _ref = i.split(' '), name = _ref[0], version = _ref[1];
